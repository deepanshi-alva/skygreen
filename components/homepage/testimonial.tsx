...
export default function TestimonialSlider() {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-black w-full py-12">

      <div className="mb-10 text-center">
    <h2 className="text-5xl md:text-6xl font-extrabold text-lime-400 mb-3 tracking-tight drop-shadow-lg">
    ...
    <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto font-light">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-6xl w-full">
        ...
        <div className="relative w-80 h-80 flex-shrink-0 flex items-end ">
          {/* Stacked images, add more for effect */}
          {testimonials.map((t, i) => {
            // Show up to 2 images in the stack for visual effect
            if (i === index) {
              return (
            ...
            // Next testimonial (simulate as bottom of stack)
            ...
            // Previous testimonial (simulate as bottom of stack, for smoother look)
          ...
          {/* Arrow controls */}
          <div className="absolute left-1/2 -bottom-15 flex gap-4 -translate-x-1/2">
            <button
              onClick={prev}
