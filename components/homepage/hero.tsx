  ...
  return (
    <section className="relative min-h-screen bg-black overflow-hidden flex flex-col items-center justify-center text-white">
      ...
      <div className={`relative z-10 text-center px-4 flex-1 flex flex-col items-center justify-center ${reveal ? "animate-fadeInSlow" : "opacity-0"}`}>
        <h2 className={`${orbitron.className} font-extrabold mb-4 leading-tight tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-green-800 via-green-300 to-green-500 animate-gradient text-[clamp(2rem,5vw+1rem,4.5rem)]`}>
          SOLAR PANELS
      ...
      <div className="absolute bottom-6 z-10 flex flex-col items-center gap-2">
        <svg className="w-[clamp(20px,2vw,28px)] h-[clamp(20px,2vw,28px)] text-green-400 animate-bounce" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <style jsx>{`
        ...
        .animate-fadeInSlow { animation: fadeInSlow 1.1s ease-out forwards; }
