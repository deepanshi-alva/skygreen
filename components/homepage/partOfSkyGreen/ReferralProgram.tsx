      ...
      >
        ...
        <div className="text-white space-y-4">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>K - Kindness</strong>: We treat every customer like our own family.
            </li>
            <li>
              <strong>Y - Yours</strong>: The energy is in your hands, not the power company’s.
            </li>
            <li>
              <strong>G - Goodness</strong>: We believe in honesty, fairness, and doing the right thing.
            </li>
            <li>
              <strong>R - Reliable</strong>: Our panels keep working in rain, dust, and heat.
            </li>
            <li>
              <strong>E - Easy</strong>: Simple to use, simple to save money.
            </li>
            <li>
              <strong>E - Equal</strong>: Every home, rich or poor, deserves clean energy.
            </li>
            <li>
              <strong>N - Nature</strong>: We care for our planet, so your children breathe better tomorrow.
            </li>
          </ul>
        </div>
      </section>
        ...
        <div className="text-white space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <strong>Share &amp; Refer</strong> → Invite friends, dealers, installers, or customers to join the SKYGREEN Family.
              </li>
              <li>
                <strong>Earn Rewards</strong> → For every successful installation, you'll earn exciting rewards and exclusive benefits. (Details will be announced soon!)
              </li>
            </ul>
          </div>
