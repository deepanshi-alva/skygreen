      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-10">
        ...
        <div className="mb-6 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-green-500 tracking-tight">
            Up to 30% Extra Power with Bifacial Gain{" "}
          </h2>
        ...
        <div className="mx-auto max-w-4xl overflow-hidden
          ...
          <table className="w-full border-collapse">
            <thead className="bg-zinc-900/70">
              <tr>
                <th className="text-left px-6 py-4 text-sm font-semibold text-zinc-200 first:border-l-0 border-l border-green-800/30">
                  Rear Side Gain
                </th>
                <th className="text-left px-6 py-4 text-sm font-semibold text-zinc-200 first:border-l-0 border-l border-green-800/30">
                  Peak Power (Pmax)
